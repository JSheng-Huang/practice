...
class Solution:
    def findMedianSortedArrays(self, nums1, nums2):
        ...
        while l < r:
            ...
            the range `nums1[m1 + 1:]`. 
            If `l` reaches `nums1` length, it means the k-th smallest number is either the first/last number in `nums1` or in `nums2`.
            """
        ...
        smallest number is not in `nums1` or `nums2`. 
        If both `m1` and `m2` are not equal to 0, choose the larger one as the 
        answer.
        """
        ...
        `nums1` or `nums2`. 
        If the length of `nums1` and `nums2` is not equal to 0, choose the 
        smaller one to average.
        """
...
class Solution:
    ...
    def findKthSmallest(self, nums1, nums1_bgn, nums1_len, nums2, nums2_bgn, nums2_len, k):
        ...
        (k/2)-th smallest number, and vice versa. 
        The maximum of `k_1` is k/2, because we always choose the smaller list 
        as `nums1`.
        """
