"""LeetCode#2900(Medium) Longest Unequal Adjacent Groups Subsequence I
...
Problem:
    ...
    1, ..., n - 1], such that for the subsequence denoted as [i0, i1, ..., ik - 
    1] having length k, groups[ij] != groups[ij + 1], for each j where 0 < j + 
    1 < k.
...
Example:
    #1:
      ...
      Output: ["e","b"]
      Explanation: 
            A subsequence that can be selected is [0,2] because groups[0] != 
        groups[2].
            So, a valid answer is [words[0],words[2]] = ["e","b"].
            Another subsequence that can be selected is [1,2] because groups[1] 
        != groups[2].
    ...
    #2:
      ...
      Output: ["a","b","c"]
      Explanation: 
            A subsequence that can be selected is [0,1,2] because groups[0] != 
        groups[1] and groups[1] != groups[2].
            So, a valid answer is [words[0],words[1],words[2]] = ["a","b","c"].
            Another subsequence that can be selected is [0,1,3] because groups
        [0] != groups[1] and groups[1] != groups[3].
...
if __name__ == '__main__':
    qwe = Solution()
    print(qwe.getWordsInLongestSubsequence(3, ["e", "a", "b"], [0, 0, 1]))
    print(qwe.getWordsInLongestSubsequence(
        4, ["a", "b", "c", "d"], [1, 0, 1, 1]))
